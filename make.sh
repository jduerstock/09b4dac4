...
powerpc-linux-gnu-ld --oformat=binary -Ttext=0xffdf8ea0 -e ffdf8ea0 -o USBHubDriver0.bin USBHubDriver0.o || exit
powerpc-linux-gnu-as -g -o USBHubDriver1.o USBHubDriver1.a || exit
powerpc-linux-gnu-ld --oformat=binary -Ttext=0xffe02280 -e ffe02280 -o USBHubDriver1.bin USBHubDriver1.o || exit
powerpc-linux-gnu-as -g -o USBHIDKeyboardModule.o USBHIDKeyboardModule.a || exit
powerpc-linux-gnu-ld --oformat=binary -Ttext=0xffe0b640 -e ffe0b640 -o USBHIDKeyboardModule.bin USBHIDKeyboardModule.o || exit
powerpc-linux-gnu-as -g -o USBHIDMouseModule.o USBHIDMouseModule.a || exit
powerpc-linux-gnu-ld --oformat=binary -Ttext=0xffe0e520 -e ffe0e520 -o USBHIDMouseModule.bin USBHIDMouseModule.o || exit
